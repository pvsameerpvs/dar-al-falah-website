...
type SanitaryWareCatalogContentProps = {
  currentTab?: string | null;
};

export default function SanitaryWareCatalogContent({ currentTab }: SanitaryWareCatalogContentProps) {
  const activeTab =
    currentTab && groupedCatalog.some((group) => slugify(group.heading) === currentTab) ? currentTab : 'all';
